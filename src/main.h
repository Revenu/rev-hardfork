...
static const uint256 hashGenesisBlock("0x00000ebc988a29ebf02daceaf8535b0da4ff06de6de68c50daa75a9c38faeba6");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((10 * 3 + 15) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at Revenu block #0
        ...
        // Before Revenu block #0 - get from pregenerated table
