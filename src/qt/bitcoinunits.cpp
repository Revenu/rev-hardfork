...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("REV");
    case mBTC: return QString("mREV");
    case uBTC: return QString::fromUtf8("μREV");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Revenus"));
    case mBTC: return QString(QObject::tr("Milli-Revenus (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Revenus (1 / 1,000,000)"));
    default: return QString("???");
    }
}
